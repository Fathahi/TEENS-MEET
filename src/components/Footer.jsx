const Footer = () => {
  return (
    <footer id="contact" className="bg-emerald-950 text-white">
      {/* Slogan Section */}
      <div className="py-20 md:py-32 px-6 border-b border-emerald-900/50">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
            ...
            <div className="space-y-12">
              <div>
                <h5 className="text-emerald-400 text-sm uppercase tracking-[0.2em] font-bold mb-8">ORGANIZED BY</h5>
                <p className="text-2xl font-bold text-white mb-2">SIO Kozhikode District Committee</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <h6 className="text-[10px] uppercase tracking-widest font-bold text-emerald-500/50">CONTACT US</h6>
                  <a href="tel:+919061390155" className="flex items-center gap-3 text-emerald-100/80 hover:text-emerald-400 font-bold transition-all">
                ...
                <div className="space-y-4">
                  <h6 className="text-[10px] uppercase tracking-widest font-bold text-emerald-500/50">EMAIL</h6>
                  <a href="mailto:siokozhikode@gmail.com" className="flex items-center gap-3 text-emerald-100/80 hover:text-emerald-400 font-bold transition-all">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Social & Legal */}
          <div className="mt-20 pt-10 border-t border-emerald-900/50 flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex gap-8 text-xs font-bold text-emerald-500/50 uppercase tracking-widest">
            ...
            <div className="flex gap-4">
              {[
                ...
                <a 
                  ...
                  className="w-12 h-12 flex items-center justify-center rounded-2xl bg-emerald-900 hover:bg-emerald-500 text-white transition-all duration-300 shadow-lg shadow-black/20"
            ...
            <p className="text-xs font-bold text-emerald-500/30 tracking-widest uppercase">
