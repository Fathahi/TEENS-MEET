...
const RecentActivity = () => {
  ...
  const activities = useMemo(() => [
    { 
      ...
      venue: 'Al Jamia Al Islamiya, Santhapuram',
    ...
    { 
      ...
      date: '24 August 2025',
      venue: 'Hira Centre Auditorium, Kozhikode',
                ...
                <div className="pro-card rounded-xl overflow-hidden group hover:scale-[1.02] active:scale-[0.98] touch-manipulation transition-all duration-300 select-none">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-start gap-2 text-gray-400">
                      ...
                      <p className="text-xs leading-relaxed">{activity.venue}</p>
                    </div>
                  </div>
                </div>
              </div>
