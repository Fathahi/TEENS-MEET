  ...
  return (
    <section id="sio" className="py-24 px-6 relative overflow-hidden bg-emerald-950">
      ...
      <div className="max-w-5xl mx-auto">
        <div ref={contentRef} className="reveal delay-[100ms] max-w-3xl mx-auto text-center space-y-12">
          <div>
            ...
            <p className="text-emerald-300/70 text-lg font-bold uppercase tracking-widest">
