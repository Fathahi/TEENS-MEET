  ...
  return (
    <header id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl px-6 text-center">
        ...
        >
          {/* Location Tag */}
          <div className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-emerald-500/10 border border-emerald-400/30 backdrop-blur-md text-xs font-bold text-emerald-100 mb-10 hover:bg-emerald-500/20 transition-all duration-300 uppercase tracking-[0.2em]">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center mt-12">
            <a
              href="#register"
              className="px-12 py-5 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-white font-bold text-lg transition-all duration-300 shadow-2xl shadow-emerald-500/30 hover:-translate-y-1 active:scale-95"
            >
              Register Now
            </a>
            <a
              href="#schedule"
              className="px-12 py-5 rounded-2xl border-2 border-white/20 bg-white/10 backdrop-blur-md hover:bg-white/20 hover:border-white/40 transition-all text-lg font-bold text-white shadow-xl hover:-translate-y-1 active:scale-95"
            >
              View Schedule
            </a>
          </div>
